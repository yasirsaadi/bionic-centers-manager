...
- **نموذج التسجيل**: الحقول السريرية **للأطراف والمساند** تظهر لـ**مدير
  ...
  من جلسة غير مخوَّلة. **العلاج الطبيعي مستثنى بقرار المالك
  (2026-07-26)**: الاستقبال يسجّل تشخيصه وإصاباته كما كان دائماً —
  آلياته مختلفة، فلا تحجبه في أي تعديل قادم.
