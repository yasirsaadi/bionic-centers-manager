...
- **نموذج التسجيل**: باني نوع البتر يظهر لـ**مدير الفرع والطبيب والمسؤول
  العام فقط**؛ الاستقبال يسجّل الهوية ونوع الحالة فقط (مع ملاحظة «يحدّدها
  الطبيب في المعاينة»). الحجب مفروض **في الخادم أيضاً**: نقطة إنشاء
  المريض تُسقط الحقول السريرية من جلسة غير مخوَّلة.
