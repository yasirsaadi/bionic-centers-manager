...
### Patient Registration Date Feature (February 2026)
- Added `registrationDate` field (date type, required) to patients table
- Displayed at the beginning of patient create/edit forms, before the patient name
- Defaults to today's date (Iraq timezone) but allows selecting past dates
- Displayed on patient details page
- Existing patients backfilled with their createdAt dates