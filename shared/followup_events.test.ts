...
// ══ **سطرُ «انتقلت العملية إلى فرع الخبير» — تاريخٌ يُقرأ** (٢٠٢٦-٠٩-٢٤) ══
//  النقلُ نفسُه أُلغي بقرار المالك، وما كُتب منه في ساعات عمله يبقى مقروءاً:
//  يقول من أين إلى أين وبأيّ خبير — بأسماء الفروع كما لُقطت في الحمولة.
console.log("\n── انتقالُ العملية إلى فرع الخبير ──");
{
  const moved = view({
    eventType: "sale_branch_moved",
    payload: {
      fromBranchId: 5, fromBranchName: "ذي قار", toBranchId: 2, toBranchName: "بغداد",
      expertUserId: 7,
    },
  });
  check("٦٤. **عنوانٌ عربيّ خاصّ** — لا «إجراء مسجَّل على الملف»",
    moved.title !== UNKNOWN_EVENT_TITLE && !LATIN.test(moved.title), moved.title);
  same("٦٥. **ويقول من أين إلى أين وبأيّ خبير** — بأسماء الفروع لا أرقامها",
    moved.facts, ["من فرع: ذي قار", "إلى فرع: بغداد", "الخبير: أيوب بغداد"]);
  //  حمولةٌ بلا لقطة أسماء (فرعٌ حُذف اسمُه، أو صفٌّ بلا اسم) ⟶ الرقم، **ولا
  //  يُخترَع اسم**.
