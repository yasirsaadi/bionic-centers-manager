...
/**
 * **الطرفُ الكاملُ لا يُباع بلا معاينة** (المرحلة الثالثة).
 *
 * الجزءُ بديلٌ لقطعةٍ وُصفت يوماً على جهازٍ قائم — قالبٌ يبلى أو ركبةٌ
 * تنكسر — فبيعُه قرارٌ تشغيليّ. أمّا **الطرفُ الكاملُ فقرارٌ سريريٌّ من
 * أوّله**: مستوى البتر ونوعُ المفصل والقدمُ والمقاس، كلُّها يقرّرها طبيب.
 * فطلبُه على مسار «بلا معاينة» طلبٌ لا يصحّ — **ويُردّ ولا يُصحَّح بصمت**:
 * تحويلُ مساره تلقائياً يدّعي قراراً لم يتّخذه أحد.
 *
 * **والمساندُ الطبية مختلفة**: لا قائمةَ أجزاءٍ قانونيةً لها بعد، فالمسندُ
 * الكاملُ يبقى مؤهَّلاً — ولا تُخترَع له أجزاءٌ لم يقلها أحد.
 */
export const NO_EXAM_FULL_PROSTHESIS_REFUSAL =
  "الطرف الصناعي الكامل يحتاج معاينة الطبيب — لا يُباع من «بلا معاينة». "
