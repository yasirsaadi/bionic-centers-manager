...
// العمود سياسةُ رؤية لا قناةُ إرسال. **والإرسالُ الفعليّ موجودٌ ويعمل** —
// واتساب عبر `server/patient_notifications/` منذ PR #238 — لكنه لا يقرأ
// من هنا مباشرة: أغلبُ الأنواع المُعلَنة أدناه لا يُصدرها أحد بعد
// (الملاحظة التالية)، وحتى الموصولُ منها يمرّ أوّلاً على موافقة المريض
// وصحّة رقمه. الحدث يُكتب ويُخزَّن بحمولةٍ آمنة أصلاً لا تُنقَّى وقت
// الإرسال.
