...
// ══ سؤالُ إرجاع المبلغ — **المرحلةُ الأولى: يُسأل ويُلزِم، ولا يفعل شيئاً بعد** ══
//
...
//
//  **وهذه المرحلةُ تسأل فقط**: الجوابُ يمنع التأكيدَ حتى يُختار، **ولا يُرسَل
//  إلى الخادم ولا يغيّر ديناراً ولا يغيّر تنفيذَ الإلغاء بحرف** — قرارُ
//  المالك صريحٌ بذلك، وحفظُ الجواب والتصرّفُ به مرحلةٌ تالية.
