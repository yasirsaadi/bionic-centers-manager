...
//
//  **وهذه المرحلةُ تسأل وتُرسِل وتحرس — ولا تُسجّل ولا تُحرّك ديناراً**:
//  الجوابُ يمنع التأكيدَ في الشاشة حتى يُختار، **ويُرسَل مع تنفيذ الإلغاء
//  الكامل وحدَه** (لا مع «التراجع عن الشراء» — لا سؤالَ هناك أصلاً)،
//  **والخادمُ يردّ التنفيذَ إن كان على العملية مبلغٌ مقبوضٌ ولم يصل جوابٌ
//  صحيح**. وما لا يفعله بعد: **لا يُسجَّل ردُّ مال، ولا يتغيّر مبلغٌ واحد،
//  ولا يُخزَّن الجوابُ نفسُه** — وتلك مرحلةٌ تالية.
//
