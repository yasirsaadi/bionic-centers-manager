...
// ══ سؤالُ إرجاع المبلغ — **يُسأل ويُلزِم، ويُرسَل، ويحرسه الخادم** ══════════
//
//  **الواقعة**: «إلغاء العملية بالكامل» يعكس البيعَ **ولا يمسّ الدفعات**
//  (قرارٌ قائم: نقدٌ قُبض واقعةٌ لا تُعاد كتابتُها — القسم ٤.ن). فيبقى للمريض
//  رصيدٌ يُوسَم `requires_financial_settlement`، **وتسويتُه خارج النظام**: قد
//  يكون المبلغُ رُدّ نقداً في حينه وقد لا يكون، ولا أحدَ يسجّل أيَّهما وقع.
//
//  فالسؤالُ يُطرح على مَن يعرف الجواب **في اللحظة التي يعرفه فيها** — لا
//  يُستنتَج بعد شهرٍ من صمت.
//
//  **والجوابُ يُسأل ويُلزِم ويُرسَل ويحرسه الخادم**: يمنع التأكيدَ في الشاشة
//  حتى يُختار، **ويُرسَل مع تنفيذ الإلغاء الكامل وحدَه** (لا مع «التراجع عن
//  الشراء» — لا سؤالَ هناك أصلاً)، **والخادمُ يردّ التنفيذَ إن كان على
//  العملية مبلغٌ مقبوضٌ ولم يصل جوابٌ صحيح**.
//
//  ══ **وفرعُ «نعم» يُنفَّذ: يُردّ الصافي المقبوض كاملاً** ═══════════════════
...
//
//  **وبعده لا تسويةَ معلَّقة**: `requires_financial_settlement` تُكتب `false`
//  و`preserved_paid_amount` صفراً — **لأن شيئاً لم يُحفَظ، رُدّ**. ووسمُ
//  «يحتاج تسوية» فوق مالٍ رُدَّ فعلاً يرسل الموظّفَ يبحث عن عملٍ لا وجودَ له.
//
...
//
//  **وفرعُ «لا» كما كان بحرفه**: لا ردَّ ولا دينار، والرصيدُ يبقى موسوماً
//  `requires_financial_settlement` — والمضيُّ مع رصيدٍ لم يُردّ قرارٌ مشروع.
//
//  **ولماذا يُحرَس في الخادم والشاشةُ تمنع أصلاً؟** لأن منعَ الشاشة ليس
//  عقداً: نافذةٌ مفتوحةٌ منذ ما قبل النشر · طلبٌ مصنوعٌ بيدٍ · **ودفعةٌ
//  تُقبَض بين المعاينة والتنفيذ** فلا تكون الشاشةُ سألت أصلاً. ثلاثتُها
//  كانت تمرّ بلا جواب. **والمبلغُ يُقرأ في الخادم تحت القفل** من صفوف
//  الدفعات — لا من جسم الطلب، ولا من لقطةِ معاينةٍ بائتة.
...
//
//  **وهذا الثاني يسأل ويُلزِم في الشاشة وحدَها** — خلافاً للأوّل الذي يُرسَل
//  ويحرسه الخادم: جوابُه لا يُرسَل إلى الخادم، ولا يغيّر ديناراً، ولا يغيّر
//  تنفيذَ الإلغاء بحرف. الذي يفعله في الشاشة:
