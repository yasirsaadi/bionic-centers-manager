...
export default function CreatePatient() {
  ...
  const [nameCheck, setNameCheck] = useState<{
    ...
    //  ═ الرسالةُ من الخادم ═══════════════════════════════════════════════
    //  الحجبُ سببُه واحد: مطابقةُ بادئةٍ لاسمِ مريضٍ **فعّال**
    //  (`active_conflict`). **والمريضُ المحذوف ليس تعارضاً** (قرارُ مالكٍ
    //  صريح، ٢٠٢٦-٠٩-١٨) — الخادمُ لا يقرؤه أصلاً، فلا حدَّ أحمرَ هنا ولا
    //  منعَ حفظ. والعميلُ يعرض الرسالةَ كما وصلت، بلا نسخةٍ ثانية قد تنحرف.
    message?: string;
  }>({ status: "empty" });
  useEffect(() => {
