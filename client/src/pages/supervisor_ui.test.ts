...
//  ══ تصحيحٌ ٢٠٢٦-٠٩-٢٥ — **وفرعُ البطاقة معها** ═══════════════════════
//  كان الفحصُ `canSupervise ?`: الأزرارُ بالقدرة وحدها، فظهرت على بطاقة فرعٍ
//  آخر يشارك ملفَّ المريض ويُردّ ضاغطُها. والقدرةُ الإشرافية ما زالت هي
//  الشرطَ لا قدرةُ التوقيع — ومعها فرعُ الطلب (قرارُ المالك). التفصيلُ في
//  `test:review-card-ui`.
check(/reviewCardMode\(\{ canSupervise, branchInScope: r\.branchInScope \}\)/.test(REVIEW),
  "١٨. **والأزرارُ تتبع القدرة الإشرافية وفرعَ الطلب** لا القدرة على التوقيع");
