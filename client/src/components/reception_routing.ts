...
// طبية»، الذي يفتح نافذةَ «جهاز جديد» القائمة نفسَها **بلا فرضِ شيء**:
// الموظّفُ يحدّد المطلوب (طرفٌ كاملٌ أو جزء) ومسارَ المعاينة داخلها كما
// كان يفعل دائماً من زرّ «طرف صناعي جديد أو جزء جديد».
//
 ...
 *
 * وكلاهما (البيع والصيانة) يذهب إلى **نافذةٍ واحدة موجودة**
