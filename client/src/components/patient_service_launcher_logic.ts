...
export type ServiceFlow =
   ...
   *
   * `initialServicePath` **اختياريّ**: حين يُمرَّر (من مُوجِّه «ما سبب
   * الحضور؟» عند اختيار «يحتاج معاينة طبية») يُفتَح `NewDeviceEpisodeModal`
   * ومحدِّدُ «هل تحتاج معاينة؟» فيه **مُعبَّأٌ مسبقاً** بالقيمة نفسها — لا
   * مقفولاً: قرارٌ تشغيليّ يصحّحه الاستقبالُ متى احتاج، لا قرارٌ سريريّ
   * موقَّع. واختيارُ **المطلوب** (طرفٌ كاملٌ أو جزء) يبقى مفتوحاً كما كان.
   * غيابُه يبقي السلوكَ القائم حرفاً.
   */
  | {
