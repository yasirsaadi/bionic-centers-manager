...
import * as migration065 from "./065_service_path_and_prior_history";
import * as migration066 from "./066_exam_commercial_ownership";
import * as migration067 from "./067_pending_service_charges";
import * as migration068 from "./068_patient_trash";
import * as migration069 from "./069_maintenance_commercial_terms";
...
import * as migration074 from "./074_medical_exam_idempotency";
import * as migration075 from "./075_ai_knowledge";
import * as migration076 from "./076_employee_training";
import * as migration077 from "./077_episode_awaiting_since";
import * as migration078 from "./078_medical_exams_episode_index";
import * as migration079 from "./079_review_request_cancelled";
import * as migration080 from "./080_patient_branch_access";
import * as migration081 from "./081_followup_decision_cancelled";
import * as migration082 from "./082_concurrent_maintenance_orders";
import * as migration083 from "./083_maintenance_warranty";
//  ٠٨٤ يصل مع فرعٍ آخر مفتوح (سجلّ محادثات المساعد)؛ الرقمان مستقلّان
//  والترتيبُ هنا هو ترتيبُ التطبيق — فالفجوةُ مؤقّتةٌ وغيرُ ضارّة.
import * as migration085 from "./085_owner_profile_knowledge";
import * as migration086 from "./086_owner_profile_scope";
