 ...
 * فعلاً** — عددُ اختصاصات الحساب، وفروعُ صفوف القائمة نفسِها — وكلاهما
 * حيٌّ. ولذلك `myExamsGuide()` **لا تأخذ `AiAccessContext` أصلاً**: منعُ
 * الاستنتاج بنيويٌّ لا وعدٌ في تعليق.
 */
 ...
 * عددُ اختصاصات الحساب، و**فروعُ صفوف القائمة نفسِها**. وكلاهما حيٌّ ليس
 ...
 *   (`operationalBranches`)، وهذا من **فروعِ الصفوف المعروضة الآن** — فطبيبٌ
 *   نطاقُه ثلاثةُ فروعٍ ولا ينتظره أحدٌ إلّا في واحدٍ منها **لا يرى
 *   المرشِّح**. فاشتقاقُه من النطاق يقلب الجواب.
 *
...
**الغرض**: المرضى المنتظرون معاينةَ **هذا الطبيب** في اختصاصاته هو — صفٌّ لكلّ
حالةٍ نشطةٍ بلا معاينةٍ موقّعة، مجمَّعةٌ بالاختصاص.
...
- **مرشِّحُ الفرع**: يظهر **فقط حين تحمل صفوفُ القائمة المعروضة الآن أكثرَ من
  فرعٍ واحد**. **⚠ وهو مشتقٌّ من الصفوف لا من نطاق عمل المستخدم**: طبيبٌ
  نطاقُه عدّةُ فروعٍ ولا ينتظره أحدٌ إلّا في فرعٍ واحد **لا يرى هذا المرشِّح** —
  وهذا صحيح، لا عطب.
