...
export const WELCOME_LINES = [
  ...
  "رقم ملفكم في نظام المراكز: {{code}}",
 ...
 * واحداً، ولا نرسل رسالةً تقول «رقم ملفكم في نظام المراكز: undefined».
 */
 ...
 *
 * ══ ولماذا قالبان ══════════════════════════════════════════════════════
 * الترحيبُ صياغةٌ ثابتة كاملة، ومتغيّرُه الوحيد رمزُ المريض — معامِلٌ واحد
 * `{{1}}`. أما التحديثُ فمعامِلان: `{{1}}` = **رمزُ المريض القانونيّ**
 * (يُقرأ حيّاً بـ`patientCodeOf` في `dispatcher.ts` وقت الإرسال، لا من هذا
 * الملفّ)، و`{{2}}` = **نصُّ هذه الدالّة نفسه** — فيربط القالبُ التحديثَ
 * بملفٍّ بعينه بدل رسالةٍ عائمة بلا هويّة. وجسمُ القالب المعتمَد في Meta:
 *
 ...
 *
 * ودمجُ القالبين في واحد كان سيجعل الترحيبَ يُقرأ بغلاف التحديث نفسه.
 *
