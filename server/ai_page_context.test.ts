...
async function main() {
  ...
  //  ── و«بعد ما تم فتح» وحدَها تابعة (ارتدادُ #344) ──────────────────────
  //  الإسقاطُ غيرُ المشروط كان يمحو **الإشارةَ الوحيدة** في سؤال متابعةٍ
  //  حقيقيّ، فيُحرَم من سياق صفحته. **والاستثناءُ صيغةٌ واحدة مؤكَّدة** لا
  //  قاعدةٌ تُعمَّم: «بعد ما» مُلاصِقتين قبل «تم» وبترتيبهما.
