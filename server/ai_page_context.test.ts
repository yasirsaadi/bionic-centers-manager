...
async function main() {
  ...
  //  ── و«تم فتح» خلفيّةً لسؤالٍ بعدها (ارتدادُ #344) ─────────────────────
  //  الإسقاطُ غيرُ المشروط كان يمحو **الإشارةَ الوحيدة** في سؤال متابعةٍ
  //  حقيقيّ، فيُحرَم من سياق صفحته. والشرطُ الآن موضعُ «تم» نفسِها: تفتح
  //  الرسالةَ أو تتلو أداةَ سؤالٍ عن الماضي ⟶ الماضي هو السؤال؛ وإلّا فهي
  //  جملةٌ تابعة والسؤالُ بعدها.
  ...
  //  **والأداتان لم تُمَسّا**: «من» تُسقط «تم فتح» حيث هي أداةُ سؤالٍ عن
  //  الماضي — فالاستثناءُ لـ«تم» المتخلّلة وحدها لا للأداتين.
