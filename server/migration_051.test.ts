...
//
// ══ ⚠ لقطةٌ تاريخية لا وصفٌ للمخطَّط اليوم ═══════════════════════════════
// هذا الملفّ **يعيد تطبيق SQL الترحيل ٠٥١ نفسِه** ثمّ يصف ما كان يضمنه
// **لحظتَه**. وترحيلان بعده غيّرا الصورة، ولا يُقرأ هذا الملفّ حجّةً عليهما:
//   • ٠٧٣ رفع `uq_pwo_one_open_build_per_service` وأحلّ محلَّه
//     `uq_pwo_one_open_build_per_episode` / `uq_pwo_one_open_legacy_build`.
//   • ٠٨٢ رفع فهرسَي الصيانة — `uq_pwo_one_open_maint_per_episode` و
//     `uq_pwo_one_open_legacy_maint` — بقرار المالك: **أيُّ عددٍ من أوامر
//     الصيانة المتزامنة مشروع، حتى لنفس الجهاز ونفس القطعة ونفس الخبير**.
// فما يقوله القسمُ «ما يبقى ممنوعاً» عن الصيانة **قاعدةٌ ملغاة**، وإنّما
